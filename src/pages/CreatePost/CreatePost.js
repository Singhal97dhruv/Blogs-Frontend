    ...
    <div className={styles.createContainer}>
      ...
      <div className={styles.contentContainer}>
        ...
        <div className={styles.content}>
          ...
          {/* </AddIcon> */}
          <TextField className={styles.field} id="filled-basic" color="success" label="Title" variant="filled" name='title' onChange={(e) => handleChange(e)} />

          <textarea className={styles.textarea} name="description" id="" cols="30" onChange={(e) => handleChange(e)} rows="10" placeholder='Share Your Thoughts!!!'></textarea>

          <button className={styles.btn} onClick={() => savePost()}>Publish</button>
        </div>
